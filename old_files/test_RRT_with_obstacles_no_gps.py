...
logging_filename = f'fly_RRT_with_obstacles_no_gps.log'
...
""" Getting gps info to start """
start_latitude = vehicle.latitude
start_longitude = vehicle.longitude
""" Calculating the goal for 10 meter """

rrt_graph = RRT(start=[start_latitude, start_longitude, 0], arrival=[-3.072650, -59.990975], logging_file=logging_filename,
                csv_filename='fly_RRT_with_obstacles_no_gps')
